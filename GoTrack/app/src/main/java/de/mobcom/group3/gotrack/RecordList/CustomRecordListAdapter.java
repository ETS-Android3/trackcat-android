...
public class CustomRecordListAdapter extends ArrayAdapter<String> {
    ...
    public CustomRecordListAdapter(Context context, List<Route> records) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        return getRecordList(position, parent);
    }

    public View getRecordList(int position, ViewGroup parent) {
