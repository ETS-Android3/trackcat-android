...
public class CurrentPageIndicator implements ViewPager.OnPageChangeListener {
    ...
    public CurrentPageIndicator(Context context, LinearLayout containerView, ViewPager viewPager, int drawableRes) {
        if (context == null) {
